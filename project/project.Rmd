...
We also observed the relationship between the average number of suicides/100k population for each year over time. The highest average number of suicides was 13.8 suicides/100k population in 1995. Suicides have been declining since then. On average, there was an average of 11.6 suicides/100k population across all the years. 

```{r year-suicides}
year_suicides<- suicide_by_countries_x %>%
  group_by(Year) %>% 
  summarize(n = mean(suicides_proportion))
```
